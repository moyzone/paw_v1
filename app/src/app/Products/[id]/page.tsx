    ...
    <main className="bg-theme-gradient text-[var(--text-primary)] overflow-hidden">
          ...
          >
            ...
            <div className="flex gap-4 flex-wrap mb-8">
              <a
                ...
                className="flex items-center gap-2 bg-accent hover:opacity-90 text-black font-semibold px-6 py-3 rounded-full transition-transform transform hover:scale-105"
              >
              ...
              <a
                ...
                className="flex items-center gap-2 border border-theme text-accent hover:bg-[var(--gold-dark)] hover:text-black font-semibold px-6 py-3 rounded-full transition"
              >
                <Package size={20} />
                Buy on Flipkart
              </a>
          ...
          <div className="space-y-6">
            {[
              ...
              <motion.div
                ...
                transition={{ duration: 0.4, delay: i * 0.1 }}
              >
                <div className="p-4 bg-accent text-black rounded-full font-bold text-2xl flex-shrink-0 flex items-center justify-center h-16 w-16">
                  {step}
                </div>
                <div>
      ...
      <section className="py-20 bg-accent-gradient text-black text-center">
        ...
        <div className="flex gap-4 justify-center flex-wrap">
          ...
          <a
            href={product.flipkartUrl}
            className="inline-block border-2 border-black text-black font-semibold px-8 py-3 rounded-full hover:bg-black hover:text-accent transition-transform transform hover:scale-105"
          >
            Buy on Flipkart
          </a>
        </div>
